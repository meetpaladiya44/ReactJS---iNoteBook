...
//   updateNote is called by edit icon of Noteitem.js which then calls Launch demo Modal button through refOpen
// setNote sets the data which is stored in variables through onChange funcion
  const updateNote = (currentNote) => {
      refOpen.current.click();
      setNote({id: currentNote._id, etitle: currentNote.title, edescription: currentNote.description, etag:currentNote.tag})
  }

//   Logic for close button of Modal
  const handleClick = (e)=>{
